/*
todo:3762. Minimum Operations to Equalize Subarrays
Hard
...
For each query, find the minimum number of operations required to make all elements in the

nums[li..ri] equal. If it is impossible, the answer for that query is -1.
